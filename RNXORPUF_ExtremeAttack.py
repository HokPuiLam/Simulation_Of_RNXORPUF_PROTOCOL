...
challenges, responses = RNXORPUF.NXORPUF(100000)
...
plt.title("Extreme ANN Attack Training and Validation Loss")
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.legend()
plt.show()
...
plt.title("Extreme ANN Attack Training and Validation accuracy")
plt.xlabel("Epochs")
plt.ylabel("accuracy")
plt.legend()
plt.show()
