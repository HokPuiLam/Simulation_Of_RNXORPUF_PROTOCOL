...
challenges, responses = RNXORPUF.NXORPUF(25000)
...
plt.title("Strong ANN Attack Training and Validation Loss")
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.legend()
plt.show()
...
plt.title("Strong ANN Attack Training and Validation accuracy")
plt.xlabel("Epochs")
plt.ylabel("accuracy")
plt.legend()
plt.show()
